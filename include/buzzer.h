...
#pragma region //Buzzer Notes
// Frequencies for musical notes (A4 = 440 Hz)
#define REST      0
#define NOTE_B0   31
#define NOTE_C1   33
#define NOTE_CS1  35
...
#pragma region //Buzzer Structs
// Struct to represent a musical note with frequency and duration
typedef struct {
    int frequency;
    int duration_ms;
} Note;

// Struct to represent a harmony note with two frequencies and a shared duration
typedef struct {
    int frequency1;    // Note for Buzzer A
    int frequency2;    // Note for Buzzer B
    int duration_ms;   // Shared duration
} HarmonyNote;
#pragma endregion
